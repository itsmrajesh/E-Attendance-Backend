...
<body>
	...
	<form action="email" autocomplete="off">
		<div class="container1">
			<font size="6" color="blue" face="courier"> UPDATE EMAIL-ID<br>
			</font> 
			<input type="text" required placeholder="Enter User Name" name="username"><br> 
				<input type="password"
				placeholder="Enter  Password" name="psw" required><br>
			<input type="email" required name="email" placeholder="Enter E-Mail" autocomplete="off"><br>
